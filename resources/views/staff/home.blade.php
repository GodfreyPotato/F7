        ...
        <div class="d-flex" style=" gap: 26px;">
            ...
            <div class="p-4"
                ...
                <div class="mb-3 text-center">
                    @if (Auth::user()->image_path)
                        <img src="{{ asset(Auth::user()->image_path) }}" alt="Profile Image" class="mb-2"
                            style="width: 120px; height: 120px; object-fit: cover; display: block; margin-left: auto; margin-right: auto;">
                    @else
                ...
                <a href="" class="btn w-100 d-flex align-items-center justify-content-center"
                    style="background-color: #1D4ED8; color: white;" data-bs-toggle="modal"
                        ...
                        <form action="{{ route('editProfile', ['id' => Auth::id()]) }}" method="POST"
                            ...
                            <div class="modal-footer d-flex j">
                                <a href="#" class="btn btn-outline-primary me-2"
                                    style="width: 5.7vw; height: 2.2vw; display: flex; align-items: center; justify-content: center;"
                    ...
                    @else
                        @if (now()->format('H:i') < '12:30')
                            <div class="p-2 me-2 "
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                                    <p style="font-size: 16px; color: #878585; margin: 0;" class="fw-semibold">AM Time In
                                    </p>
                            ...
                            <div class="p-2 me-2 "
                                style="width: 50%; height: 40%; box-shadow: 0px 0px 4.2px 0px rgba(0, 0, 0, 0.25); background-color: white; border-radius: 8px;">
                                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                                    <p style="font-size: 16px; color: #878585; margin: 0;" class="fw-semibold">AM Time Out
                                    </p>
                                    <span class="fw-bold" style="font-size: 24px; margin: 0;">
                        ...
                        @else
                            ...
                            <div class="p-2 me-2 "
                                style="width: 50%; height: 40%; box-shadow: 0px 0px 4.2px 0px rgba(0, 0, 0, 0.25); background-color: white; border-radius: 8px;">
                                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                                    <p style="font-size: 16px; color: #878585; margin: 0;" class="fw-semibold">PM Time In
                                    </p>
                                    <span class="fw-bold" style="font-size: 24px; margin: 0;">
                            ...
                            <div class="p-2 me-2 "
                                style="width: 50%; height: 40%; box-shadow: 0px 0px 4.2px 0px rgba(0, 0, 0, 0.25); background-color: white; border-radius: 8px;">
                                <div class="d-flex flex-column align-items-center justify-content-center text-center">
                                    <p style="font-size: 16px; color: #878585; margin: 0;" class="fw-semibold">PM Time Out
                                    </p>
                                    <span class="fw-bold" style="font-size: 24px; margin: 0;">
