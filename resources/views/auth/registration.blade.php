        ...
        <div >
            ...
            <form method="POST" action="{{ route('registration.store') }}" class="mt-4">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3" style="width:45%;">
                        ...
                        <input type="text" name="firstname" class="form-control" id="name" value="{{ old('firstname') }}"
                            required style="height: 3vw; width: 11vw;">
                    </div>
                    <div class="mb-3" style="width:45%;">
                ...
                <div class="mb-3">
                    ...
                    <select name="department" class="form-control" style="height: 3vw; width: 25vw;">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password_confirmation" class="form-control" id="password_confirmation"
                        required style="height: 3vw; width: 25vw;">
                </div>

                <button type="submit" class="btn btn-primary w-100"  style="height: 3vw; width: 25vw;">Register</button>
            </form>
