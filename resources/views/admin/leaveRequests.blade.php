...
@section('content')
    <div class="container" style="margin-top: 5vw;">
        <div class="d-flex flex-column">
            ...
            <div class="p-4" style="box-shadow: 0px 0px 4.2px 0px rgba(0, 0, 0, 0.25); background-color: white; border-radius: 8px;">
                <form class="d-flex">
                    <input type="search" placeholder="Search..." style="padding:12px; width: 82vw; height: 3vw; border: 2px solid #BCBCBC; border-radius: 0.5vw;">
                </form>
            </div>

            {{-- LEAVE REQUESTS --}}
            <div class="p-4 mt-4" style="box-shadow: 0px 0px 4.2px 0px rgba(0, 0, 0, 0.25); background-color: white; border-radius: 8px;">
           ...
           @foreach ($leaves as $leave )
                <div class="p-4 d-flex justify-content-between align-items-center"
                    ...
                    <div class="d-flex flex-column">
                        <p class="fw-bold mb-0" style="font-size: 18px;">Gwen Salvador</p>
                    ...
                    <a href="{{route('leave.show',['leave'=>$leave])}}" class="btn d-flex justify-content-center align-items-center"
    ...
    <nav class="mt-5">
        ...
        <!-- Prev Button -->
        <li class="page-item">
            <a class="page-link fw-bold text-primary"
            href="#"
